...
export default function Home() {
  ...
  const [showSelectorLoginOrSignup, setShowSelectorLoginOrSignup] = useAtom(
    showSelectorLoginOrSignupAtom,
  );
    ...
    <>
      {isLogedIn ? (
        ...
        >
          <div
            id="Main-container"
            className="flex flex-col sm:flex-row gap-4 min-h-screen w-full justify-between"
          >
            <div id="SideBar-Container" className="hidden sm:block">
              <SideBar />
            </div>
            <div
        ...
        <div className="min-h-screen w-full bg-[#f9fafb] relative">
          ...
          <div id="Desktop-NavBar-Container" className="hidden sm:inline">
            <NavBar />
          </div>
          <div id="Mobile-NavBar-Container" className="sm:hidden">
            <MobileNavBar />
          </div>
          <div
            id="Main-Container"
          ...
          >
            ...
            <div
              ...
              className="mb-8 w-full text-center text-gray-600 p-6"
            >
              <p className="text-base sm:text-lg lg:text-2xl">
                {/* TODO:改行の場所変えられるなら変える */}
                <strong>PochiNote</strong>
                は、あなたの資産管理をシンプルかつ効果的にサポートするためのモダンアプリケーションです。
                <br />
            ...
            <div
              id="feature-cards"
              className="flex flex-col gap-6 mb-8 w-full max-w-6xl"
            >
              {/* Feature Card 1 */}
              <div className="flex flex-col sm:flex-row justify-between bg-white rounded-lg shadow-md p-6 hover:shadow-xl transition-shadow duration-300">
                <div className="flex-col">
                  ...
                  <p className="my-auto py-4 text-gray-600 text-md">
                    直感的なチャートとグラフで、あなたの収入と支出を一目で把握できます。
                    <br />
              ...
              <div className="flex flex-col sm:flex-row justify-between bg-white rounded-lg shadow-md p-6 hover:shadow-xl transition-shadow duration-300">
                ...
                <p className="my-auto py-4 text-gray-600 text-md">
                  あなたの支出パターンを分析し、節約のヒントや投資の機会を提案します。
                  <br />
